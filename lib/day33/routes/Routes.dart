...
import '../pages/user/registerFirst.dart' show RegisterFirstPage;
import '../pages/user/registerSecond.dart' show RegisterSecondPage;
import '../pages/user/registerThird.dart' show RegisterThirdPage;
import '../pages/user/login.dart' show LoginPage;
